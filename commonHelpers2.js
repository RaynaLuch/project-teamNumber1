import{r as l,b as u,g as p,i as m}from"./assets/manage-cart-4cfa80cd.js";const n=document.querySelector(".product-list"),g=document.querySelector(".sub-container"),y=document.querySelector(".delete-btn"),a=document.querySelector(".count"),v=document.querySelector(".amount"),b=`<div class="empty">
