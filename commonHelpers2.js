import{r as i,b as u,g as p,i as m}from"./assets/manage-cart-3cc21ff7.js";const g="/project-teamNumber1/assets/yellow-shopping-basket-88cc64a6.png",n=document.querySelector(".product-list"),y=document.querySelector(".sub-container"),b=document.querySelector(".delete-btn"),a=document.querySelector(".count"),h=document.querySelector(".amount"),v=`<div class="empty">
